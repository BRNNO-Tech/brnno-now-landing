        ...
        <div className="min-h-screen bg-dark text-white relative">
            ...
            <main className="relative z-10 px-6 lg:px-10 pb-20 pt-8">
                <div className="max-w-5xl mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-12">
                    <div>
                        <p className="label-mono text-text-secondary mb-4">CONTACT</p>
                        <h1 className="headline-lg text-white mb-6">Let us know how we can help.</h1>
                        <p className="text-text-secondary text-lg leading-relaxed mb-10 max-w-xl">
                            Drop a note about partnerships, press, or general questions. This form opens your email client and
                            sends to contact@brnno.com.
                        </p>

                        <div className="glass-card p-6 border border-white/5">
                            <p className="text-sm text-text-secondary mb-2">Prefer email?</p>
                            <a
                                href="mailto:contact@brnno.com"
                    ...
                    <form
                        ...
                        action="mailto:contact@brnno.com"
                        method="post"
                        encType="text/plain"
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                name="topic"
                                type="text"
                                placeholder="Partnerships, press, general"
                                className="w-full rounded-2xl bg-white/5 border border-white/10 px-4 py-3 text-white placeholder:text-text-secondary focus:border-yellow/60 focus:outline-none"
                            />
                        </div>
