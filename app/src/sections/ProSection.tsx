...
const ProSection = ({ className = '' }: ProSectionProps) => {
    ...
    >
      <div ref={contentRef} className="absolute inset-0">
        ...
        <div
          ...
          style={{ opacity: 0 }}
        >
          <p className="label-mono text-text-secondary mb-4">BRNNO PRO</p>
          ...
          <p className="text-text-secondary text-base md:text-lg leading-relaxed mb-6 md:mb-8">
            Get booked by local customers, manage your schedule, and get paid fast—right from your phone.
          </p>

          <a href="https://app.brnno.com/detailer-signup" target="_blank" rel="noopener noreferrer" className="btn-accent flex items-center gap-2 inline-flex">
            Apply to join
            <ArrowRight size={18} />
          </a>
        </div>
        ...
        >
          ...
          <span className="text-sm text-text-secondary">Weekly payouts • Insurance support</span>
        </div>
      </div>
    </section>
  );
